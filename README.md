...
- **Attack Pattern:** Daily bi-modal pattern from January 8-12.
...
- **Detection Gap Analysis:** Reviewed alert logic to identify opportunities for earlier detection (reducing time-to-detect from 5 days to 1 day).
...
2.  **Eradication Procedures:** Credential resets, disk review for persistence mechanisms.
3.  **Recovery & Hardening:** Implementation of account lockout policies, and network segmentation rules.

## Artifacts & Documentation
- [Forensic Timeline](Report/Investigation-Timeline.md) (Log-based event reconstruction)
- [Response Action ](Report/Response-Actions.md) (Mapped to NIST CSF)
